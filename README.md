...
4. 动手学深度学习[link](http://zh.gluon.ai/)
5. 零基础入门深度学习[link](https://www.zybuluo.com/hanbingtao/note/433855)
6. Model Zoo [link](https://modelzoo.co/)
7. 神经网络模型图示 [github](https://github.com/weslynn/AlphaTree-graphic-deep-neural-network) 
8. AI算法工程师手册 [link](http://www.huaxiaozhuan.com/)
...
1. RFCN_CoupleNet    pytorch   [github](https://github.com/princewang1994/RFCN_CoupleNet.pytorch) 
2. Yolo-v2 pytorch  [github](https://github.com/vietnguyen91/Yolo-v2-pytorch)
3. RFBNet pytorch  [github](https://github.com/ruinmessi/RFBNet)
4. CFENet pytorch  [github](https://github.com/Yiming992/CFENet)
...
3. AUNet for Panoptic Segmentation
4. multi-task-refinenet  pytorch [github](https://github.com/DrSleep/multi-task-refinenet)
5. BiSeNet  pytorch [github](https://github.com/ooooverflow/BiSeNet)
...
9. Pluralistic-Inpainting  pytorch  [github](https://github.com/lyndonzheng/Pluralistic-Inpainting)
...
3. Gunicorn配置 [link](https://www.cnblogs.com/nanrou/p/7026789.html)
4. Python资源大全中文版 [github](https://github.com/jobbole/awesome-python-cn?from=hw798&lid=330)
5. Web 应用 & 框架 [link](https://pythonguidecn.readthedocs.io/zh/latest/scenarios/web.html)
6. Flask中文文档 [link](https://dormousehole.readthedocs.io/en/latest/)
